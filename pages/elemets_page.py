...
from ..locators.elemets_page_locator import ButtonsPageLocators, CheckBoxPageLocators, LinksPageLocators, RadioButtonPageLocators, TextBoxPageLocators, UploadDownloadPageLocators, WebTablePageLocators
